...
const Timeline = () => {
    return (
        <>
            <h1 className="-mt-10 text-center text-6xl max-sm:-mt-30 sm:-mt-30 md:-mt-30 sm:text-4xl md:text-6xl lg:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-emerald-300 to-white leading-tight">My Journey</h1>
            <div className="w-full relative px-4 md:px-0 min-h-screen mt-20">
                {/* Vertical lines */}
