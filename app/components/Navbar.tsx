...
const Navbar = ({ isSidebarOpen }: any) => {
  return (
    <nav className='w-full bg-transparent h-[100px] mx-auto flex items-center'>
        <div className='w-[40px] h-[40px] rounded-md bg-white flex items-center justify-center z-23'><p className='text-2xl text-black font-bold'>M</p></div>
        <div className='hidden justify-center items-center w-[90%] h-full md:flex lg:flex xl:flex 2xl:flex'>
            ...
            <button className='pt-[7px] pb-[7px] pl-[12px] pr-[12px] absolute right-10 cursor-pointer hover:bg-foreground bg-white text-sm font-medium rounded-lg text-black'>Get in touch</button>
        </div>
        <div className={isSidebarOpen ? "w-screen h-screen bg-black absolute inset-0 z-22 flex items-center justify-center mx-auto" : "hidden"}>
            ...
            <button className='pt-[7px] pb-[7px] pl-[12px] pr-[12px] absolute bottom-30 bg-white text-sm font-medium rounded-lg text-black'>Get in touch</button>
        </div>
    </nav>
  )
}
