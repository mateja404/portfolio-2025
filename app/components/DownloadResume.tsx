...
const DownloadResume = () => {
  ...
  return (
    <motion.div ref={ref} initial={{ x: -50, opacity: 0 }} animate={inView ? { opacity: 1, x: 0 } : { opacity: 0, x: -50 }} transition={{ duration: .3 }} className='w-full min-h-[220px] xl:h-[220px] flex-1 relative rounded-xl bg-gradient-to-r from-emerald-400/60 via-emerald-300 to-emerald-100/70 pt-[50px] pb-[50px] pl-[30px] pr-[30px] flex flex-col md:flex-row lg:flex-row xl:flex-row gap-10'>
