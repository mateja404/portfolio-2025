    ...
    <main className='relative z-20 w-full max-w-5xl mx-auto px-7 py-7'>
        ...
        <section className={isSidebarOpen ? 'hidden' : 'w-full mx-auto xl:mt-15 py-6 md:py-12 flex flex-col-reverse xl:flex-row 2xl:flex-row items-center justify-between gap-10'}>
          ...
          <div className='w-full xl:w-1/2 flex items-center relative'>
            <Image src={"https://cdn.studiozid.rs/heroimg.webp"} priority alt='hero image' fetchPriority='high' width={280} height={280} className='rounded-full object-cover lg:float-right lg:absolute lg:right-0 lg:mt-35 xl:-mt-20 xl:float-right xl:absolute xl:right-0 max-sm:static max-sm:mx-auto sm:static sm:mx-auto'/>
          </div>
        </section>
